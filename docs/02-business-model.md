...
5. **Inversiones vía partner** — revenue share por acciones/ETFs, sin ser broker propio
6. **Crypto vía exchange aliado** — fee/revenue share por compra/venta, con disclosure de riesgo
...
- TAM(Total addressable market) objetivo: 3M (usuarios con perfil tech-savvy, ingresos > $1.5M COP/mes)
- SAM(Serviceable Available Market) año 1: 200K (Bogotá + Medellín, early adopters)
- SOM(Serviceable Obtainable Market) año 1: 50K usuarios activos
...
### Segmento 3 — Ahorro, multi-moneda, acciones y crypto
